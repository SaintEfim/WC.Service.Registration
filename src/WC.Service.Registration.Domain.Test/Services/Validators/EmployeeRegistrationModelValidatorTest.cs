...
public class EmployeeRegistrationModelValidatorTest
{
    ...
    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_Short_Email()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
        model.Email = new string('x', CommonConstants.GenericEmailMinLength - 1);
        var res = _validator.TestValidate(model);
        res.ShouldHaveAnyValidationError()
            .WithErrorMessage("The length of 'Email' must be at least 8 characters. You entered 7 characters.")
            .Only();
    }

    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_Long_Email()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
        model.Email = new string('x', CommonConstants.GenericEmailMaxLength + 1);
        var res = _validator.TestValidate(model);
        res.ShouldHaveAnyValidationError()
            .WithErrorMessage("The length of 'Email' must be 64 characters or fewer. You entered 65 characters.")
            .Only();
    }

    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_An_Incorrect_Email()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
        model.Email = "test@@mail.ru";
        var res = _validator.TestValidate(model);
        res.ShouldHaveAnyValidationError()
            .WithErrorMessage("Email must contain exactly one '@' symbol.")
            .Only();
    }

    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_Without_Special_Character()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
    ...
    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_Not_Correct_Domain_In_Email()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
    ...
    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_Password_Without_Number()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
    ...
    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_Password_Without_Lowercase_Letters()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
    ...
    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_A_Password_That_Has_A_Space()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
    ...
    [Fact]
    public void EmployeeRegistration_Negative_Create_New_Record_With_Short_Name()
    {
        var model = EmployeeRegistrationData.EmployeeRegistrationModel();
        model.Name = new string('x', CommonConstants.GenericNameMinLength - 1);
        var res = _validator.TestValidate(model);
        res.ShouldHaveAnyValidationError()
            .WithErrorMessage(
